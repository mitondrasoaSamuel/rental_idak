...
function SectionCategorie({ className }) {
  ...
  return (
    <div className={className} id="categories">
      <div className="w-full sm:w-[595px] bg-red-100/ lg:full xl:w-[1200px] 2xl:w-[1470px] flex flex-col justify-around items-center gap-y-14 mx-5">
        <div className=" w-full bg-red-300/ flex flex-col justify-between items-center gap-y-5">
          <h2 className="font-bold text-3xl  md:text-5xl text-black ">
            Featured Listings
          </h2>
          <Ligne className="flex justify-center gap-x-2 " />
        </div>

        <div className=" w-full flex flex-col items-center p-2 h-[1374px]/ bg-red-300/  space-y-14">
          <div className="w-full flex flex-col justify-center  bg-red-300/ p-5  ">
            <Slider {...settings}>
              {mapBouton.map(({ name }) => (
          ...
          <div className=" w-full  bg-red-500/ space-y-[60px] ">
            <div className=" w-full  flex flex-col  gap-y-16 lg:flex-row  lg:flex-wrap lg:gap-10 lg:justify-center lg:items-center 2xl:flex-row 2xl:gap-x-5 2xl:justify-center bg-red-100/ px-5  ">
              ...
              <div className=" bg-green-400/ w-full lg:w-[48vh] h-[605px] border border-black/25 rounded-lg">
                <Card
                  style={{
